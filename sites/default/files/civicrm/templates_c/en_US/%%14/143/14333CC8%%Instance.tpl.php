<?php /* Smarty version 2.6.27, created on 2014-02-13 13:42:16
         compiled from CRM/Report/Form/Instance.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Report/Form/Instance.tpl', 1, false),array('block', 'ts', 'CRM/Report/Form/Instance.tpl', 26, false),array('function', 'help', 'CRM/Report/Form/Instance.tpl', 29, false),array('modifier', 'crmAddClass', 'CRM/Report/Form/Instance.tpl', 51, false),)), $this); ?>
...
<br />
 ...
 <?php echo smarty_function_help(array('id' => "id-is_reserved",'file' => "CRM/Report/Form/Settings.hlp"), $this);?>
</td>
      ...
      cj(\'#_qf_\' + formName + \'_submit_next\').click (
          function(){
              if ( cj(\'#title\').data(\'initial_value\') == cj(\'#title\').val() ) {
                  var confirmMsg = '; ?>
'<?php $this->_tag_stack[] = array('ts', array('escape' => 'js')); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>You are saving a copy of this report with the same report title. Are you sure you want to continue?<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>'<?php echo '
                  return confirm(confirmMsg);
              }
          }
      );
