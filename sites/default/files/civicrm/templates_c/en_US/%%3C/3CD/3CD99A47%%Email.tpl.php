...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Page/Inline/Email.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Page/Inline/Email.tpl', 28, false),array('modifier', 'nl2br', 'CRM/Contact/Page/Inline/Email.tpl', 59, false),)), $this); ?>
...
?>
 ...
 <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Email<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
      ...
      <div class="crm-content crm-contact_email <?php if ($this->_tpl_vars['item']['is_primary'] == 1): ?>primary<?php endif; ?>">
        <a href="mailto:<?php echo $this->_tpl_vars['item']['email']; ?>
