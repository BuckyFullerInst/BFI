...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/Tag.tpl', 1, false),array('block', 'ts', 'CRM/common/Tag.tpl', 24, false),array('function', 'crmKey', 'CRM/common/Tag.tpl', 19, false),array('function', 'crmURL', 'CRM/common/Tag.tpl', 45, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (! $this->_tpl_vars['tagsetType'] || $this->_tpl_vars['tagsetType'] == 'contact'): ?>
