<?php /* Smarty version 2.6.27, created on 2014-02-13 12:16:12
         compiled from CRM/Admin/Page/Tag.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Admin/Page/Tag.tpl', 1, false),array('block', 'ts', 'CRM/Admin/Page/Tag.tpl', 34, false),array('function', 'docURL', 'CRM/Admin/Page/Tag.tpl', 27, false),array('function', 'crmURL', 'CRM/Admin/Page/Tag.tpl', 41, false),array('function', 'cycle', 'CRM/Admin/Page/Tag.tpl', 67, false),array('function', 'crmKey', 'CRM/Admin/Page/Tag.tpl', 171, false),array('modifier', 'replace', 'CRM/Admin/Page/Tag.tpl', 75, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_docURL(array('page' => "user/organising-your-data/groups-and-tags"), $this);?>
...
?><?php echo '<tr class="'; ?><?php echo smarty_function_cycle(array('values' => "odd-row,even-row"), $this);?><?php echo ' '; ?><?php echo $this->_tpl_vars['row']['class']; ?><?php echo ' crm-tag crm-entity" id="tag-'; ?><?php echo $this->_tpl_vars['row']['id']; ?><?php echo '"><td class="crm-tag-name crm-editable crmf-name">'; ?><?php echo $this->_tpl_vars['row']['name']; ?><?php echo '</td><td class="crm-tag-id">'; ?><?php echo $this->_tpl_vars['row']['id']; ?><?php echo '</td><td class="crm-tag-description crm-editable crmf-description">'; ?><?php echo $this->_tpl_vars['row']['description']; ?><?php echo ' </td><td class="crm-tag-parent">'; ?><?php echo $this->_tpl_vars['row']['parent']; ?><?php echo ''; ?><?php if ($this->_tpl_vars['row']['parent_id']): ?><?php echo ' ('; ?><?php echo $this->_tpl_vars['row']['parent_id']; ?><?php echo ')'; ?><?php endif; ?><?php echo '</td><td class="crm-tag-used_for">'; ?><?php echo $this->_tpl_vars['row']['used_for']; ?><?php echo '</td><td class="crm-tag-is_tagset">'; ?><?php if ($this->_tpl_vars['row']['is_tagset']): ?><?php echo '<img src="'; ?><?php echo $this->_tpl_vars['config']->resourceBase; ?><?php echo 'i/check.gif" alt="'; ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo 'Tag Set'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '" />'; ?><?php endif; ?><?php echo '</td><td class="crm-tag-is_reserved">'; ?><?php if ($this->_tpl_vars['row']['is_reserved']): ?><?php echo '<img src="'; ?><?php echo $this->_tpl_vars['config']->resourceBase; ?><?php echo 'i/check.gif" alt="'; ?><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo 'Reserved'; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '" />'; ?><?php endif; ?><?php echo '</td><td>'; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['action'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'xx', $this->_tpl_vars['row']['id']) : smarty_modifier_replace($_tmp, 'xx', $this->_tpl_vars['row']['id'])); ?><?php echo '</td></tr>'; ?><?php endforeach; endif; unset($_from); ?><?php echo '</table>'; ?>
