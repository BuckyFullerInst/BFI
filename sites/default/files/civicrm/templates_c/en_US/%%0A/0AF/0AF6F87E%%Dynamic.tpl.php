<?php /* Smarty version 2.6.27, created on 2014-02-07 16:29:22
         compiled from CRM/Profile/Form/Dynamic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Profile/Form/Dynamic.tpl', 1, false),array('block', 'crmRegion', 'CRM/Profile/Form/Dynamic.tpl', 27, false),array('block', 'ts', 'CRM/Profile/Form/Dynamic.tpl', 59, false),array('modifier', 'truncate', 'CRM/Profile/Form/Dynamic.tpl', 71, false),array('modifier', 'substr', 'CRM/Profile/Form/Dynamic.tpl', 175, false),array('modifier', 'cat', 'CRM/Profile/Form/Dynamic.tpl', 176, false),array('modifier', 'replace', 'CRM/Profile/Form/Dynamic.tpl', 196, false),array('function', 'crmURL', 'CRM/Profile/Form/Dynamic.tpl', 321, false),)), $this); ?>
...
"<?php echo ';
    var blockNo = '; ?>
<?php if ($this->_tpl_vars['blockNo']): ?><?php echo $this->_tpl_vars['blockNo']; ?>
    ...
    var response = cj.ajax({
      ...
      success: function( response ) {
        if ( response.newContactSuccess ) {
          ...
          CRM.alert(response.displayName + '; ?>
