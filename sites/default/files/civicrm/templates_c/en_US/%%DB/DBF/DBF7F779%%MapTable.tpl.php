<?php /* Smarty version 2.6.27, created on 2014-02-13 15:13:35
         compiled from CRM/Contact/Import/Form/MapTable.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Import/Form/MapTable.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Import/Form/MapTable.tpl', 33, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><div class="crm-block crm-form-block crm-import-maptable-form-block">
...
$this->_sections['rows']['first']      = ($this->_sections['rows']['iteration'] == 1);
$this->_sections['rows']['last']       = ($this->_sections['rows']['iteration'] == $this->_sections['rows']['total']);
?><?php echo ''; ?><?php $this->assign('j', $this->_sections['rows']['index']); ?><?php echo '<td class="odd-row">'; ?><?php echo $this->_tpl_vars['dataValues'][$this->_tpl_vars['j']][$this->_tpl_vars['i']]; ?><?php echo '</td>'; ?><?php endfor; endif; ?><?php echo ''; ?><?php echo '<td class="form-item even-row'; ?><?php if ($this->_tpl_vars['wizard']['currentStepName'] == 'Preview'): ?><?php echo ' labels'; ?><?php endif; ?><?php echo '">'; ?><?php if ($this->_tpl_vars['wizard']['currentStepName'] == 'Preview'): ?><?php echo ''; ?><?php if ($this->_tpl_vars['relatedContactDetails'] && $this->_tpl_vars['relatedContactDetails'][$this->_tpl_vars['i']] != ''): ?><?php echo ''; ?><?php echo $this->_tpl_vars['mapper'][$this->_tpl_vars['i']]; ?><?php echo ' - '; ?><?php echo $this->_tpl_vars['relatedContactDetails'][$this->_tpl_vars['i']]; ?><?php echo ''; ?><?php if ($this->_tpl_vars['relatedContactLocType'] && $this->_tpl_vars['relatedContactLocType'][$this->_tpl_vars['i']] != ''): ?><?php echo '- '; ?><?php echo $this->_tpl_vars['relatedContactLocType'][$this->_tpl_vars['i']]; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['relatedContactPhoneType'] && $this->_tpl_vars['relatedContactPhoneType'][$this->_tpl_vars['i']] != ''): ?><?php echo '- '; ?><?php echo $this->_tpl_vars['relatedContactPhoneType'][$this->_tpl_vars['i']]; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['relatedContactImProvider'] && $this->_tpl_vars['relatedContactImProvider'][$this->_tpl_vars['i']] != ''): ?><?php echo '- '; ?><?php echo $this->_tpl_vars['relatedContactImProvider'][$this->_tpl_vars['i']]; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['relatedContactWebsiteType'] && $this->_tpl_vars['relatedContactWebsiteType'][$this->_tpl_vars['i']] != ''): ?><?php echo '- '; ?><?php echo $this->_tpl_vars['relatedContactWebsiteType'][$this->_tpl_vars['i']]; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php if ($this->_tpl_vars['locations'][$this->_tpl_vars['i']]): ?><?php echo ''; ?><?php echo $this->_tpl_vars['locations'][$this->_tpl_vars['i']]; ?><?php echo ' -'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['phones'][$this->_tpl_vars['i']]): ?><?php echo ''; ?><?php echo $this->_tpl_vars['phones'][$this->_tpl_vars['i']]; ?><?php echo ' -'; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['ims'][$this->_tpl_vars['i']]): ?><?php echo ''; ?><?php echo $this->_tpl_vars['ims'][$this->_tpl_vars['i']]; ?><?php echo ' -'; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php if ($this->_tpl_vars['websites'][$this->_tpl_vars['i']]): ?><?php echo ''; ?><?php echo $this->_tpl_vars['websites'][$this->_tpl_vars['i']]; ?><?php echo ' -'; ?><?php endif; ?><?php echo ''; ?><?php echo ''; ?><?php echo $this->_tpl_vars['mapper'][$this->_tpl_vars['i']]; ?><?php echo ''; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php else: ?><?php echo ''; ?><?php echo $this->_tpl_vars['form']['mapper'][$this->_tpl_vars['i']]['html']; ?><?php echo ''; ?><?php endif; ?><?php echo '</td></tr>'; ?><?php endfor; endif; ?><?php echo '</table>'; ?>
...
unset($_smarty_tpl_vars);
 ?>
            ...
            <?php echo '
      cj(function() {
        var defaultLocationType = "'; ?>
<?php echo $this->_tpl_vars['defaultLocationType']; ?>
<?php echo '";
        if (defaultLocationType.length) {
          cj(\'#map-field\').on(\'change\', \'select[id^="mapper"][id$="_0"]\', function() {
            ...
            cj(\'option\', select).each(function() {
              ...
              && cj(this).text() == "'; ?>
<?php echo $this->_tpl_vars['defaultLocationTypeLabel']; ?>
<?php echo '") {
