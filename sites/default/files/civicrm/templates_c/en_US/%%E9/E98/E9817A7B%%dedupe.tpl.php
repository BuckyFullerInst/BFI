<?php /* Smarty version 2.6.27, created on 2014-02-13 17:15:54
         compiled from CRM/common/dedupe.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/common/dedupe.tpl', 1, false),array('block', 'ts', 'CRM/common/dedupe.tpl', 14, false),array('function', 'crmURL', 'CRM/common/dedupe.tpl', 63, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><div id='processDupes' class="success-status" style="display:none;"></div>
<?php echo '
