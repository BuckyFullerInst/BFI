<?php /* Smarty version 2.6.27, created on 2014-02-13 11:52:38
...
?><?php echo '<tr id="row_'; ?><?php echo $this->_tpl_vars['row']['id']; ?><?php echo '" class="crm-job '; ?><?php echo smarty_function_cycle(array('values' => "odd-row,even-row"), $this);?><?php echo ' '; ?><?php echo $this->_tpl_vars['row']['class']; ?><?php echo '"><td class="crm-joblog-run_datetime">'; ?><?php echo $this->_tpl_vars['row']['run_time']; ?><?php echo '</td><td class="crm-joblog-name">'; ?><?php echo $this->_tpl_vars['row']['name']; ?><?php echo '</td><td class="crm-joblog-details"><div class="crm-joblog-command">'; ?><?php echo $this->_tpl_vars['row']['command']; ?><?php echo '</div>'; ?><?php if ($this->_tpl_vars['row']['description']): ?><?php echo '<div class="crm-joblog-description"><span class="bold">Summary</span><br/>'; ?><?php echo $this->_tpl_vars['row']['description']; ?><?php echo '</div>'; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['row']['data']): ?><?php echo '<div class="crm-joblog-data" style="border-top:1px solid #ccc; margin-top: 10px;"><span class="bold">Details</span><br/><pre>'; ?><?php echo $this->_tpl_vars['row']['data']; ?><?php echo '</pre></div>'; ?><?php endif; ?><?php echo '</td></tr>'; ?><?php endforeach; endif; unset($_from); ?><?php echo '</table>'; ?>
