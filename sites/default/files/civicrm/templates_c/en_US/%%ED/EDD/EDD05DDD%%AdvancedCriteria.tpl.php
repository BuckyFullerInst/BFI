<?php /* Smarty version 2.6.27, created on 2014-02-07 19:25:44
         compiled from CRM/Contact/Form/Search/AdvancedCriteria.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Search/AdvancedCriteria.tpl', 1, false),array('block', 'ts', 'CRM/Contact/Form/Search/AdvancedCriteria.tpl', 51, false),array('function', 'crmURL', 'CRM/Contact/Form/Search/AdvancedCriteria.tpl', 89, false),array('function', 'help', 'CRM/Contact/Form/Search/AdvancedCriteria.tpl', 116, false),)), $this); ?>
...
<?php $this->_tag_stack[] = array('ts', array('escape' => 'js')); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Loading<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><?php echo '...</span></div>\');
      header.append(\''; ?>
<a href="#" class="crm-close-accordion" title="<?php $this->_tag_stack[] = array('ts', array('escape' => 'js')); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Remove from search criteria<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><span><?php $this->_tag_stack[] = array('ts', array('escape' => 'js')); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Reset<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span> &nbsp;<img src="<?php echo $this->_tpl_vars['config']->resourceBase; ?>
i/close.png" /></a><?php echo '\');
...
?><?php echo '<div class="crm-accordion-wrapper crm-ajax-accordion crm-'; ?><?php echo $this->_tpl_vars['paneValue']['id']; ?><?php echo '-accordion '; ?><?php if ($this->_tpl_vars['paneValue']['open'] == 'true' && $this->_tpl_vars['openedPanes'][$this->_tpl_vars['paneName']]): ?><?php echo ' '; ?><?php else: ?><?php echo 'collapsed'; ?><?php endif; ?><?php echo '"><div class="crm-accordion-header" id="'; ?><?php echo $this->_tpl_vars['paneValue']['id']; ?><?php echo '">'; ?><?php echo $this->_tpl_vars['paneName']; ?><?php echo '</div><div class="crm-accordion-body '; ?><?php echo $this->_tpl_vars['paneValue']['id']; ?><?php echo '"></div></div>'; ?><?php endforeach; endif; unset($_from); ?><?php echo '<div class="spacer"></div><table class="form-layout"><tr><td>'; ?><?php echo $this->_tpl_vars['form']['buttons']['html']; ?><?php echo '</td></tr></table>'; ?>
