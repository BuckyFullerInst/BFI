...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Contact/Form/Edit/TagsAndGroups.tpl', 1, false),array('function', 'cycle', 'CRM/Contact/Form/Edit/TagsAndGroups.tpl', 50, false),array('modifier', 'is_numeric', 'CRM/Contact/Form/Edit/TagsAndGroups.tpl', 54, false),)), $this); ?>
...
<?php endif; ?>
    <table class="form-layout-compressed<?php if ($this->_tpl_vars['context'] == 'profile'): ?> crm-profile-tagsandgroups<?php endif; ?>">
      <tr>
       <?php if ($this->_tpl_vars['groupElementType'] == 'crmasmSelect'): ?>
          <td><span class="label"><?php if ($this->_tpl_vars['title']): ?><?php echo $this->_tpl_vars['form']['group']['label']; ?>
<?php endif; ?></span>
