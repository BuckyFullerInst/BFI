<?php /* Smarty version 2.6.27, created on 2014-02-13 11:30:53
         compiled from CRM/Mailing/Form/Upload.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Mailing/Form/Upload.tpl', 1, false),array('block', 'ts', 'CRM/Mailing/Form/Upload.tpl', 30, false),array('function', 'help', 'CRM/Mailing/Form/Upload.tpl', 30, false),array('function', 'docURL', 'CRM/Mailing/Form/Upload.tpl', 72, false),array('modifier', 'crmAddClass', 'CRM/Mailing/Form/Upload.tpl', 55, false),)), $this); ?>
...
<table class="form-layout-compressed">
 ...
 <?php echo smarty_function_help(array('id' => "id-from_email",'isAdmin' => $this->_tpl_vars['isAdmin']), $this);?>
</td>
    </tr>
    <?php if ($this->_tpl_vars['trackReplies']): ?>
    <tr class="crm-mailing-upload-form-block-reply_to_address">
        <td style="color:#3E3E3E;"class="label"><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Reply-To<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?><span class="crm-marker">*</span></td>
        <td><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Auto-Generated<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
    </tr>
    <?php else: ?>
    <tr class="crm-mailing-upload-form-block-reply_to_address">
        <td class="label"><?php echo $this->_tpl_vars['form']['reply_to_address']['label']; ?>
</td>
        <td><?php echo $this->_tpl_vars['form']['reply_to_address']['html']; ?>
</td>
    </tr>
    <?php endif; ?>
  ...
  <td><?php echo $this->_tpl_vars['form']['template']['html']; ?>
    ...
    <tr class="crm-mailing-upload-form-block-subject"><td class="label"><?php echo $this->_tpl_vars['form']['subject']['label']; ?>
        ...
        <td colspan="2"><?php echo ((is_array($_tmp=$this->_tpl_vars['form']['subject']['html'])) ? $this->_run_mod_handler('crmAddClass', true, $_tmp, 'huge') : smarty_modifier_crmAddClass($_tmp, 'huge')); ?>
...
unset($_smarty_tpl_vars);
 ?>
  ...
  <?php ob_start(); ?><?php echo smarty_function_docURL(array('page' => 'Sample CiviMail Messages','text' => "More information and sample messages...",'resource' => 'wiki'), $this);?>
