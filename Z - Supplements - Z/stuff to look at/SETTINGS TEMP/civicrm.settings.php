 ...
 */
define( 'CIVICRM_UF_DSN'           , 'mysql://username:password@localhost/drupal_?new_link=true' );
 ...
 *
 */
define( 'CIVICRM_DSN'          , 'mysql://username:password@localhost/drupal_db?new_link=true' );
